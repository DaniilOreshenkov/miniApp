...
const CreateProjectSheet: React.FC<Props> = ({
  ...
  return (
    <>
      ...
      <div aria-hidden="true" style={getKeyboardGuardStyle(sheetLayout, open)} />
    </>
  );
};
...
const getSheetFrameStyle = (
  ...
  left: 0,
  right: 0,
  top: `var(--sheet-frame-top, ${sheetLayout.frameTop}px)`,
  height: `var(--sheet-frame-height, ${sheetLayout.frameHeight}px)`,
  zIndex: 130,
  display: "flex",
  alignItems: "flex-end",
