      ...
      <div style={contentWrapStyle}>
        <div style={headerZoneStyle}>
          ...
          <div style={screenMetaRowStyle}>
            <div style={screenMetaChipStyle}>
              Сетка {settings.width}×{settings.height}
            </div>
...
const headerZoneStyle: React.CSSProperties = {
  ...
  paddingBottom: 10,
  background:
    "linear-gradient(180deg, rgba(247,248,251,0.96) 0%, rgba(247,248,251,0.88) 72%, rgba(247,248,251,0) 100%)",
