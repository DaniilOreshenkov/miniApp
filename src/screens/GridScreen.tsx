...
const GridScreen: React.FC<Props> = ({ onBack, data, onSave }) => {
  ...
  const handleShapeInteractionModeChange = (nextMode: ShapeInteractionMode) => {
    setShapeInteractionMode(nextMode);
    setTool("shape");
  };
        ...
        <div style={canvasWrapper}>
          <div style={canvas}>
            ...
            <BottomToolbar
              ...
              shapeInteractionMode={shapeInteractionMode}
              onShapeInteractionModeChange={handleShapeInteractionModeChange}
